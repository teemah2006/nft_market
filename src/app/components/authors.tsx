...
const users = [
    ...
    { avatar: Images.avatar1, username: "marvinmckin", items: 479, collections: 24 },
    { avatar: Images.avatar2, username: "esther_howard", items: 387, collections: 10 },
];


export default function Authors() {
    return (
        <div className="rounded-2xl h-min lg:h-max lg:h-auto w-full bg-gray-900 p-4 my-8 box-border gradient1">
            <div className="relative rounded-xl -top-[2.5rem] pl-4 text-gray-500 gradient2 w-1/3 h-[50px] -left-[1rem] skew-x-10 font-extrabold text-left tracking-wider">
                . . .
            </div>
            <div className="flex flex-row gap-6 p-10 box-border">
                <div className="w-1/2">
                    <small className="text-gray-500 text-[16px] tracking-wide">OVERLINE</small>
                    <h1 className="lg:text-[50px] text-[30px] font-bold font-serif my-6 text-sm/14">Sapien Ipsum scelerisque convallis fusse. Join now </h1>
