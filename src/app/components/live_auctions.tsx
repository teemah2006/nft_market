...
export const Nftcard: React.FC<Nftcardprops> = ({ src, desc, alt, price, bidding, time, likes, liked, avatar, author }) => {
    return (
        <div className='rounded-2xl h-min lg:h-max w-auto bg-black bg-opacity-50 p-4 my-8 mx-4 overflow-hidden'>
            ...
            <div className='text-[16px]  flex flex-row flex-wrap justify-between gap-6 items-center my-4'>
                <h1 className='text-white font-bold text-[1rem]  text-left w-[70%]'>{desc} <span className='hidden'>{author}</span></h1>
